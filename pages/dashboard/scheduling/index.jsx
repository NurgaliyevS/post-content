      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
          ...
          <div className="tabs mb-4">
            ...
            <button disabled className="tab tab-bordered flex items-center gap-2 opacity-50">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-8">
              <div className="flex-1">
                <p className="text-sm text-gray-500 mb-2">Asia/Almaty timezone</p>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-4">
                    <button className="p-1"><HiChevronLeft className="w-5 h-5" /></button>
                    <span className="font-medium">March 2025</span>
                    <button className="p-1"><HiChevronRight className="w-5 h-5" /></button>
                  </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col h-[308px] gap-2 overflow-y-scroll scrollbar-visible">
                  {timeOptions.map((time, i) => (
                    <button
                      key={i}
                      onClick={() => setSelectedTime(time)}
                      className={`
                        px-4 py-1 rounded-[8px] text-sm text-center
                        transition-all duration-200
                        ${selectedTime === time 
                          ? 'bg-black text-white'
                          : 'bg-white border border-[#B8B8B8] hover:bg-white'
                        }
                      `}
                    >
                      {time}
