...
export default function HeroSection() {
  ...
  return (
    <div className="text-center px-4 py-16 mx-auto">
      ...
      <div className="hidden md:block max-sm:-mx-8 mt-16">
        <div className="absolute top-1/4 -left-4 -translate-x-full text-sm flex flex-col gap-1 items-center">
          <p className="text-base-content/80">Watch the demo</p>
